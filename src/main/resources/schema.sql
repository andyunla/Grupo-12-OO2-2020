...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`empleado` (
  ...
  CONSTRAINT `fk_empleado_local1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`local` (`id_local`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`pedidostock` (
  ...
  CONSTRAINT `fk_pedidostock_empleado1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`empleado` (`id_empleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`chango` (
  ...
  CONSTRAINT `fk_chango_pedidostock1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`pedidostock` (`id_pedido_stock`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`factura` (
  ...
  CONSTRAINT `fk_factura_cliente1`
    FOREIGN KEY (`id_cliente`)
    REFERENCES `Grupo-12-BDD-OO2-2020`.`cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
