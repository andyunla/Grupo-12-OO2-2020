...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`empleado` (
  ...
  CONSTRAINT `fk_empleado_local1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`local` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empleado_persona1`
    FOREIGN KEY (`id`)
    REFERENCES `Grupo-12-BDD-OO2-2020`.`persona` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`pedidostock` (
  ...
  CONSTRAINT `fk_pedidostock_empleado1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`empleado` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_pedidostock_producto1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`producto` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`chango` (
  ...
  CONSTRAINT `fk_chango_pedidostock1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`pedidostock` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Grupo-12-BDD-OO2-2020`.`factura` (
  ...
  CONSTRAINT `fk_factura_cliente1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`cliente` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_factura_chango1`
    ...
    REFERENCES `Grupo-12-BDD-OO2-2020`.`chango` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
